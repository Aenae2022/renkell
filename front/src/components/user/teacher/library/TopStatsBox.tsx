...
function TopStatsBox({
  myDatas,
  topScore,
  title,
  typeTop,
}: {
  myDatas: BookStatType[];
  topScore: number[];
  title: string;
  typeTop: string;
}) {
            ...
            <table className={tableStyle}>
              <tbody>
                {myDatas.map((book) => {
                  ...
                  switch (typeTop) {
                    case "borrow":
                      nbTotal = book.statsBorrow.total;
                      concerned = book.statsBorrow.concerned;
                      break;
                    case "read":
                      nbTotal = book.statsReaded.total;
                      concerned = book.statsReaded.concerned;
                      break;
                    default:
                      break;
                  }

...
import type { Cube } from "@srcFront/features/exercises/denombre1/denombre1.types";
import { layoutGrid } from "@srcFront/features/exercises/denombre1/denombre1.layout";
import { animeCorrection } from "@srcFront/features/exercises/denombre1/denombre1.engine";
type NombreDecType = {
  nbUnite: number;
  nbDizaine: number;
  nbCentaine: number;

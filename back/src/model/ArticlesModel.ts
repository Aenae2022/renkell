...
static async getArticlesByDomaine(domaine: string) {
    try {
        const articlesByDomaine = await prisma.article.findMany({
            where: {
                domaineId: domaine,
            },
            select: {
...
static async getArticlesBySousDomaine(sousDomaine: string) {
    try {
        const articlesBySousDomaine = await prisma.article.findMany({
            where: {
